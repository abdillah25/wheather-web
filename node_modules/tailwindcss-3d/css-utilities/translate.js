...
var Translate = /*#__PURE__*/ function(Base) {
    "use strict";
    _inherits(Translate, Base);
    var _super = _create_super(Translate);
    function Translate() {
        _class_call_check(this, Translate);
        var _this;
...
_define_property(Translate, "defaultFunctionValues", {
    translateX: "var(--tw-translate-x)",
    translateY: "var(--tw-translate-y)",
    translateZ: "var(--tw-translate-z)"
});
_define_property(Translate, "normaliseFunctionValues", function() {
